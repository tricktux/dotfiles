...
let g:ctags_cmd = (has('nvim') ? ':Cs' : ':cs')

function! s:setup_cscope_mappings()
  " cscope mappings
  nmap <leader>pa <plug>cs_assignment_to_symbol
  nnoremap <silent> <expr> <plug>cs_assignment_to_symbol g:ctags_cmd . ' find a <c-r><c-w><cr>'
  nmap <leader>pc <plug>cs_funtions_calling_func
  nnoremap <silent> <expr> <plug>cs_funtions_calling_func g:ctags_cmd . ' find c <c-r><c-w><cr>'
  nmap <leader>pd <plug>cs_functions_called_by_func
  nnoremap <silent> <expr> <plug>cs_functions_called_by_func g:ctags_cmd . ' find d <c-r><c-w><cr>'
  nmap <leader>pe <plug>cs_egrep_pattern
  nnoremap <silent> <expr> <plug>cs_egrep_pattern g:ctags_cmd . ' find e <c-r><c-w><cr>'
  nmap <leader>pf <plug>cs_this_file
  nnoremap <silent> <expr> <plug>cs_this_file g:ctags_cmd . ' find f<cr>'
  nmap <leader>pg <plug>cs_definition
  nnoremap <silent> <expr> <plug>cs_definition g:ctags_cmd . ' find g <c-r><c-w><cr>'
  nmap <leader>pi <plug>cs_files_including_this_file
  nnoremap <silent> <expr> <plug>cs_files_including_this_file g:ctags_cmd . ' find i <c-r><c-w><cr>'
  nmap <leader>ps <plug>cs_c_symbol
  nnoremap <silent> <expr> <plug>cs_c_symbol g:ctags_cmd . ' find s <c-r><c-w><cr>'
  nmap <leader>pt <plug>cs_text_string
  nnoremap <silent> <expr> <plug>cs_text_string g:ctags_cmd . ' find t <c-r><c-w><cr>'
  ...
  nnoremap <silent> <expr> <plug>cs_add_database g:ctags_cmd . ' add '

...
/usr/bin/tmux new-session -d -s $session -n 'mailserver' 'neomutt -F ~/.config/neomutt/user.molinamail'
/usr/bin/tmux new-window -d -t $session -n 'gmail' 'neomutt -F ~/.config/neomutt/user.gmail'
/usr/bin/tmux new-window -d -t $session -n 'ufl' 'neomutt -F ~/.config/neomutt/user.ufl'
...
/usr/bin/tmux new-window -d -t $session -n 'pm' 'sleep 5; neomutt -F ~/.config/neomutt/user.pm'
